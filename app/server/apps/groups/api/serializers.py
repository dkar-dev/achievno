...
class GroupCreateSerializer(serializers.Serializer):
    title = serializers.CharField(min_length=2, max_length=160, trim_whitespace=True)
    description = serializers.CharField(required=False, allow_blank=True, allow_null=True)
    visibility_type = serializers.ChoiceField(choices=["public", "private"], default="public")
...
class DemoGroupJoinSerializer(serializers.Serializer):
    template_id = serializers.SlugField(max_length=80)
    title = serializers.CharField(min_length=2, max_length=160, trim_whitespace=True)
    description = serializers.CharField(required=False, allow_blank=True, allow_null=True)
    visibility_type = serializers.ChoiceField(choices=["public", "private"], default="public")
...
class GroupAchievementCreateSerializer(serializers.Serializer):
